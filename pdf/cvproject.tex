...
\begin{abstract}
  Our project aims to remove the surgical mask over a person face by
  ...
  mask are then feeded through the network which will output the reconstructed
  face. It is also possible to have a second photo of the same person without
  the sugical mask that can be used as reference. From this photo, a small
  ...
  provide to the network more information about the face thus lead to a more
  loyal reconstruction.
\end{abstract}

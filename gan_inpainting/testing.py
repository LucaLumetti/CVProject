...
if __name__ == '__main__':
    ...
    netG.load_state_dict(torch.load('models/generator.pt', map_location=torch.device('cpu')))
    netD.load_state_dict(torch.load('models/discriminator.pt', map_location=torch.device('cpu')))
